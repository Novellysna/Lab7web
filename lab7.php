    ...
    <div class="container">
        ...
        <form method="POST" action="lab7.php">
            ...
            <select id="pekerjaan" name="pekerjaan" required>
                ...
                <option value="programmer" <?php echo (($_POST['pekerjaan'] ?? '') == 'programmer' ? 'selected' : ''); ?>>
                    Programmer</option>
                <option value="designer" <?php echo (($_POST['pekerjaan'] ?? '') == 'designer' ? 'selected' : ''); ?>>
                    Designer Grafis</option>
                <option value="manager" <?php echo (($_POST['pekerjaan'] ?? '') == 'manager' ? 'selected' : ''); ?>>
                    Manager Proyek</option>
                <option value="guru" <?php echo (($_POST['pekerjaan'] ?? '') == 'guru' ? 'selected' : ''); ?>>Guru Sekolah
                </option>
            </select>
